...
def main(args):
    VisionFM_val_file_path = '../VisionFM/Final_prediction_Selection/VisionFM_pred_F_256.pickle'
    with open(VisionFM_val_file_path, 'rb') as file:
        VisionFM_val_feats = pickle.load(file)
    val_path = '../VisionFM/dataset/fundus/F/subtest_labels.txt'
    ...
    RETFound_val_file_path = '../VisionFM/Final_prediction/RETFound_pred_F_128.pickle'
    ...
    FLAIR_val_file_path ='../VisionFM/Final_prediction/FLAIR_pred_F_64.pickle'
    ...
    CLIP_val_file_path = '../VisionFM/Final_prediction/CLIP_pred_F_32.pickle'
    ...
    auc_matrix = np.power(auc_matrix, 4)   #A,B,C,D;4
    ...
    log_file = "../VisionFM/all_score_classification_logs/CLIP_Mixture_F.log"

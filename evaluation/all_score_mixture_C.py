...
def main(args):
    ...
    RETFound_val_file_path = '../VisionFM/Final_prediction_Selection/RETFound_pred_C_128.pickle'
    ...
    FLAIR_val_file_path ='../VisionFM/Final_prediction_Selection/FLAIR_pred_C_256.pickle'
    ...
    CLIP_val_file_path = '../VisionFM/Final_prediction_Selection/CLIP_pred_C_128.pickle'
    ...
    final_predictions = RETFound_val_fea
    
    log_file = "../VisionFM/all_score_classification_logs/CLIP_Mixture_C.log"
    ...
    with open(log_file, 'a', encoding='utf-8') as f:
        ...
        try:
            ...
            output_path = os.path.join(output_dir, "RETFound_C_predictions_with_labels.txt")

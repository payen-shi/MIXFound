...
def main(args):
    VisionFM_val_file_path = '../VisionFM/Final_prediction_Selection/VisionFM_pred_E_32.pickle'
    with open(VisionFM_val_file_path, 'rb') as file:
        VisionFM_val_feats = pickle.load(file)
    val_path = '../VisionFM/dataset/fundus/E/subtest_labels.txt'
    ...
    RETFound_val_file_path = '../VisionFM/Final_prediction/RETFound_pred_E_0.pickle'
    ...
    FLAIR_val_file_path ='../VisionFM/Final_prediction/FLAIR_pred_E_0_new.pickle'
    ...
    CLIP_val_file_path = '../VisionFM/Final_prediction_Selection/CLIP_pred_E_128.pickle'
    ...
    log_file = "../VisionFM/all_score_classification_logs/CLIP_Mixture_E.log"

...
def main(args):
    ...
    RETFound_val_file_path = '../VisionFM/Final_prediction_Selection/RETFound_pred_B_32.pickle'
    ...
    FLAIR_val_file_path ='../VisionFM/Final_prediction_Selection/FLAIR_pred_B_64.pickle'
    ...
    CLIP_val_file_path = '../VisionFM/Final_prediction_Selection/CLIP_pred_B_64.pickle'
    ...
    final_predictions =RETFound_val_fea#VisionFM_val_fea#fused_preds #CLIP_val_fea #fused_preds 
    log_file = "../VisionFM/all_score_classification_logs/CLIP_Mixture_B.log"
    ...
    with open(log_file, 'a', encoding='utf-8') as f:
        ...
        try:
            ...
            output_dir = "../VisionFM/fairness_analysis"
            ...
            output_path = os.path.join(output_dir, "RETFound_B_predictions_with_labels.txt")

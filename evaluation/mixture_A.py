...
def main(args):
    ...
    RETFound_val_file_path = '../VisionFM/Final_prediction_Selection/RETFound_pred_A_64.pickle'
    ...
    FLAIR_val_file_path ='../VisionFM/Final_prediction_Selection/FLAIR_pred_A_256.pickle'
    ...
    CLIP_val_file_path = '../VisionFM/Final_prediction_Selection/CLIP_pred_A_32.pickle'
    ...
    auc_matrix = np.power(auc_matrix, 6)   #A,B,C,D;4
    ...
    plot_combined_roc(
        ...
        output_path="../VisionFM/classification_ROC/A2.png"
    )
    
    log_file = "../VisionFM/classification_logs/Mixture_A.log"

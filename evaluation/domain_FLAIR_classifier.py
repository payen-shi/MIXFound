...
def confusion_matrix_figure(prediction,target):
    ...
    plt.savefig("../VisionFM/domain_confusion_matrix/FLAIR_newest.png", dpi=600, bbox_inches='tight')
    plt.close()
...
def main(args):
    ...
    with open("../VisionFM/Final_feature/FLAIR_feature_training_domain.pickle", 'rb') as file:
        train_feats = pickle.load(file)
    with open("../VisionFM/Final_feature/FLAIR_feature_test_domain.pickle", 'rb') as file:
...
def validate_network(loader, epoch,linear_classifier):
    log_file = "../VisionFM/domain_logs/FLAIR_4_domain.log"

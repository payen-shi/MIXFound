...
def main(args):
    ...
    models = {
        'VisionFM': VisionFM_val_fea,
        'RETFound': RETFound_val_fea,
        'FLAIR': FLAIR_val_fea,
        'CLIP': CLIP_val_fea,
        'MIXFound': final_predictions
    }
    
    class_names = ["Glaucoma", "Myopia", "Normal"]
    
    plot_combined_roc(
        models_dict=models,
        y_true=val_label,
        class_names=class_names,
        output_path="../VisionFM/classification_ROC/F2.png"
    )
    
    log_file = "../VisionFM/classification_logs/Mixture_F.log"
